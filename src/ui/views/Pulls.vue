        ...
        <div v-for="group in groups" :key="group.id" class="pull-group">
          ...
          >
            ...
            <div class="pull-content">
              ...
              <ui-pull-chart :values="pull.lines" />
...
.pulls {
  ...
  .pull {
    ...
    &.alert h3 {
      ...
      span {
        animation: pull-alert 1.5s linear infinite;
      }
    }
    ...
    .pull-reviewer {
      ...
      @for $i from 0 through $pullReviewerAnimationCount {
        ...
        &.r-#{$i} {
          animation: pull-reviewer-#{$i} $sec linear infinite;

          .pull-reviewer-container {
            animation: pull-reviewer-stable-#{$i} $sec linear infinite;
          }
        }
      }
